...
import { clients, flagmanyClient } from '../../../../data/clients/clients'

describe('Флагманы образования client', () => {

    const header = new Header
    const loginPage = new LoginPage
    const regPage = new RegistrationPage

    const client: tQueryParams = clients(flagmanyClient)
    ...
    it('Отображается логотип Флагманы образования', () => {
