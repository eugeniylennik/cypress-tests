...
import { clients, flagmanyddClient } from '../../../../data/clients/clients'

describe('Флагманы доп. образования client', () => {

    const header = new Header
    const loginPage = new LoginPage
    const regPage = new RegistrationPage

    const client: tQueryParams = clients(flagmanyddClient)
    ...
    it.skip('Отображается логотип Флагманы доп. образования', () => {
