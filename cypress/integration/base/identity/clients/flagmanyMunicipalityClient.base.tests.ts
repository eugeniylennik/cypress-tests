...
import { clients, flagmanyMunicipalityClient } from '../../../../data/clients/clients'

describe('Флагманы образования Муниципалитет client', () => {

    const header = new Header
    const loginPage = new LoginPage
    const regPage = new RegistrationPage

    const client: tQueryParams = clients(flagmanyMunicipalityClient)
    ...
    it('Отображается логотип Флагманы образования Муниципалитет', () => {
